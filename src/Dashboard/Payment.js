...
const stripePromise = loadStripe(
  "pk_test_51LbSnRLHwpmroVsRQRIg2DK9wAyMETRbdOiloPfTor3pAXm5W401WEEhaKCbe6zj1B4m9WORxTkJxhpDHzifADYc000trTOUtx"
);
...
const Payment = () => {
  ...
  return (
    <>
      <div class="card w-50 max-w-md bg-base-100 shadow-xl my-12 mx-auto">
        <div class="card-body">
          ...
          <p className="text-warning">
            Your Appointment: {booking.date} at {booking.slot}
          </p>
      ...
      <div>
        <div class="card w-50 max-w-md bg-base-200 mx-auto shadow-xl">
          <div class="card-body">
