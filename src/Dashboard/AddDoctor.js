...
const AddDoctor = () => {
  ...
  /*  const { data:services, isLoading } = useQuery('serviceName', () => fetch('https://dentist-doctor.up.railway.app/servicesName').then(res => res.json()))
  ...
  const onSubmit = async (data) => {
    ...
    fetch("https://dentist-doctor.up.railway.app/doctorInfo", {
      method: "POST",
      headers: {
